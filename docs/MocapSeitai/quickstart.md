...
For posture differences, see [Retarget adjustments](/MocapSeitai/retarget-adjustments). For hand-position differences, see [Spatial hands](/MocapSeitai/spatial-hands).
