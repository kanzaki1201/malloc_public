...
You changed an Actor body value while the loop was running. Press **Realign actor rig** (see [the panel at a glance](/MocapSeitai/reference/)). The warning clears once you do.
